...
def test_simple_voice_detector():
    """Test Simple Voice Detector"""
    try:
        from src.ai.simple_voice_detector import SimpleVoiceDetector
        ...
        logger.info("Testing Simple Voice Detector...")
...
if __name__ == "__main__":
    print("=== TEST SIMPLE VOICE DETECTOR ===")
    
    # Test simple voice detector
    print("\n1. Testing Simple Voice Detector...")
    success = test_simple_voice_detector()
    
    # Ket qua
    print("\n=== KET QUA ===")
    if success:
        print("SIMPLE VOICE DETECTOR HOAT DONG CHINH XAC!")
