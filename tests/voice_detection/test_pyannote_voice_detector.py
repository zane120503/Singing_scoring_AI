...
def test_pyannote_voice_detector():
    """Test PyAnnote Voice Detector"""
    try:
        from src.ai.pyannote_voice_detector import PyAnnoteVoiceDetector
        ...
        logger.info("Testing PyAnnote Voice Detector...")
        logger.info(f"File: {test_file}")
        
        # Khoi tao detector
        detector = PyAnnoteVoiceDetector()
        ...
        if segments:
            ...
            logger.info(f"   Detection method: {first_segment['method']}")
...
if __name__ == "__main__":
    print("=== TEST PYANNOTE VOICE DETECTOR ===")
    
    # Test pyannote voice detector
    print("\n1. Testing PyAnnote Voice Detector...")
    success = test_pyannote_voice_detector()
    
    # Ket qua
    print("\n=== KET QUA ===")
    if success:
        print("PYANNOTE VOICE DETECTOR HOAT DONG CHINH XAC!")
