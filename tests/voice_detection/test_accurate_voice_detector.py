...
def test_accurate_voice_detector():
    """Test Accurate Voice Detector"""
    try:
        from src.ai.accurate_voice_detector import AccurateVoiceDetector
        ...
        logger.info("Testing Accurate Voice Detector...")
        logger.info(f"File: {test_file}")
        
        # Khoi tao detector
        detector = AccurateVoiceDetector()
...
if __name__ == "__main__":
    print("=== TEST ACCURATE VOICE DETECTOR ===")
    
    # Test accurate voice detector
    print("\n1. Testing Accurate Voice Detector...")
    success = test_accurate_voice_detector()
    
    # Ket qua
    print("\n=== KET QUA ===")
    if success:
        print("ACCURATE VOICE DETECTOR HOAT DONG CHINH XAC!")
