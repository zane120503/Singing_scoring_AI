...
# -*- coding: utf-8 -*-
"""
Test Ultra Precise Voice Detector
"""
...
def test_ultra_precise_voice_detector():
    """Test Ultra Precise Voice Detector"""
    try:
        from src.ai.ultra_precise_voice_detector import UltraPreciseVoiceDetector
        ...
        logger.info("🎯 Testing Ultra Precise Voice Detector...")
        logger.info(f"File: {test_file}")
        
        # Khởi tạo detector
        detector = UltraPreciseVoiceDetector()
...
if __name__ == "__main__":
    print("=== TEST ULTRA PRECISE VOICE DETECTOR ===")
    
    # Test ultra precise voice detector
    print("\n1. Testing Ultra Precise Voice Detector...")
    success = test_ultra_precise_voice_detector()
    
    # Kết quả
    print("\n=== KET QUA ===")
    if success:
        print("✅ ULTRA PRECISE VOICE DETECTOR HOAT DONG CHINH XAC!")
