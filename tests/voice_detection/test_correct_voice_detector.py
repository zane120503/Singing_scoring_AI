...
def test_correct_voice_detector():
    """Test Correct Voice Detector"""
    try:
        from src.ai.correct_voice_detector import CorrectVoiceDetector
        ...
        logger.info("Testing Correct Voice Detector...")
        logger.info(f"File: {test_file}")
        
        # Khoi tao detector
        detector = CorrectVoiceDetector()
        ...
        if segments:
            ...
            if 4.0 < detected_start < 8.0:  # Giong hat thuong bat dau trong khoang 4-8 giay
...
if __name__ == "__main__":
    print("=== TEST CORRECT VOICE DETECTOR ===")
    
    # Test correct voice detector
    print("\n1. Testing Correct Voice Detector...")
    success = test_correct_voice_detector()
    
    # Ket qua
    print("\n=== KET QUA ===")
    if success:
        print("CORRECT VOICE DETECTOR HOAT DONG CHINH XAC!")
