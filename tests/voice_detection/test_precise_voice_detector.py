...
def test_precise_voice_detector():
    """Test Precise Voice Detector"""
    try:
        from src.ai.precise_voice_detector import PreciseVoiceDetector
        ...
        logger.info("🎯 Testing Precise Voice Detector...")
        logger.info(f"File: {test_file}")
        
        # Khởi tạo detector
        detector = PreciseVoiceDetector()
...
if __name__ == "__main__":
    print("=== TEST PRECISE VOICE DETECTOR ===")
    
    # Test precise voice detector
    print("\n1. Testing Precise Voice Detector...")
    success = test_precise_voice_detector()
    
    # Kết quả
    print("\n=== KET QUA ===")
    if success:
        print("✅ PRECISE VOICE DETECTOR HOAT DONG CHINH XAC!")
