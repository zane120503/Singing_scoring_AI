...
# -*- coding: utf-8 -*-
"""
Test AI Audio Separator - chi giu lai 1 file MP3
"""
...
def test_single_mp3_output():
    """Test AI Audio Separator chi tao 1 file MP3"""
    print("=== TEST AI AUDIO SEPARATOR - SINGLE MP3 OUTPUT ===")
                    ...
                    if os.path.exists(vocals_path):
                        ...
                        if os.path.exists(output_dir):
                            ...
                            if len(files) == 1:
                                ...
                                print(f"   ⚠️ WARNING: {len(files)} files in output directory (expected 1)")
                        else:
