...
# -*- coding: utf-8 -*-
"""
Test Audio Separator AI trong hệ thống karaoke scoring
"""
...
def test_audio_separator_integration():
    ...
    try:
        ...
        # Test với AI Mode (không phải Fast Mode)
        ...
        # Test vocal separation với file mẫu
        ...
        if os.path.exists(test_file):
            ...
            if processor.audio_separator and processor.audio_separator.available:
                ...
                try:
                    ...
                    print(f"   ✅ AI Mode vocals saved: {vocals_path}")
                except Exception as e:
                    print(f"   ❌ AI Mode error: {e}")
            
            # Test Fast Mode
            print("   Testing Fast Mode vocal separation...")
            try:
                vocals_path = fast_processor.separate_vocals(test_file)
                print(f"   ✅ Fast Mode vocals saved: {vocals_path}")
            except Exception as e:
        ...
        try:
            ...
            # Test key detection với file vocals
            if os.path.exists(test_file):
        ...
        try:
            ...
            print(f"   ✅ Scoring System initialized")
            
            # Test scoring với file mẫu
            if os.path.exists(test_file):
                # Tạo file beat giả (cùng file để test)
                beat_file = test_file
